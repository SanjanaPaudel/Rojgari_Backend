...
class BookingCreationTests(APITestCase):
    def setUp(self):
        ...
        self.worker_profile.current_latitude = Decimal("27.7172")
        self.worker_profile.current_longitude = Decimal("85.3240")
        self.worker_profile.last_location_update = timezone.now()
...
class MatchingTests(APITestCase):
    ...
    def _make_worker(self, email, phone, lat, lon, rating, jobs, online=True):
        ...
        profile.current_longitude = Decimal(str(lon))
