    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_location', models.TextField(blank=True, help_text='Geometry representation (e.g., GeoJSON or WKT)', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('worker', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='documents', to='accounts.worker')),
            ],
        ),
    ]
